...
class TestDecomposeIssueTask:
    ...
    def test_decompose_issue_task_success(
        self, mock_decompose_ai, create_user, workspace, project, issue
    ):
    ...
    @pytest.mark.django_db
    def test_decompose_issue_task_issue_not_found(self, create_user, workspace):
...
class TestProcessBrainDumpTask:
    ...
    def test_process_brain_dump_task_success_with_auto_create(
        self, mock_extract_ai, create_user, workspace, project
    ):
    ...
    @pytest.mark.django_db
    def test_process_brain_dump_task_project_not_found(self, create_user, workspace):
