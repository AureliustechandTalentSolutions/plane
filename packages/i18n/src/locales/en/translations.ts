...
export default {
  ...
  execuflow: {
    ...
    error_boundary: {
      widget_error: "{{widgetName}} encountered an error",
      try_again: "Try again",
      retry_attempt: "Retry attempt {{attempt}} of {{max}}",
      error_persists: "The error persists. Please refresh the page.",
      reporting_error: "Error has been reported to our team.",
    },
    focus_mode: {
      title: "Focus Mode",
      active_title: "Focus Mode Active",
      hint: "Distractions are minimised. Queued notes appear below.",
      end_focus: "End Focus",
      start_session: "Start focus session",
      end_session: "End focus session",
      focus_on: "Focus On",
      focus_off: "Focus Off",
      quick_note_placeholder: "Quick note...",
    },
    session_states: {
      idle: "Idle",
      working: "Working",
    ...
    interrupt_queue: {
      empty: "No queued interruptions",
      queued_items: "{{count}} queued item",
      queued_items_plural: "{{count}} queued items",
    },
    dragon_companion: {
      avatar_label: "Dragon companion - {{mood}}",
    },
    aria: {
      focus_timer_region: "Focus timer widget",
      energy_tracker_region: "Energy tracker widget",
      timer_display: "Timer showing {{time}}",
      timer_paused: "Timer paused at {{time}}",
      select_energy_level: "Select your current energy level",
      select_focus_duration: "Select focus duration",
    },
  },
} as const;
